                ...
                <div class="sidebar sidebar-style-1 sidebar-style-2">
                    <ul class="sidebar-container">
                        ...
                        <li class="sidebar-item active">
                            <a href="resources/views/services-detail-2.blade.php">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="resources/views/services-detail-2.blade.php">Home Insurance</a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="resources/views/services-detail-2.blade.php">Business Insurance</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
